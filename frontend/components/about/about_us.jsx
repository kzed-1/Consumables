            ...
            <div className="about-us-container">
                ...
                <div className="our-story">
                    ...
                    <p className ="our-story-description"> Consumables is a clone of Instructables. Like Instrutables, Consumables allow users to create, update, and delete instructions. 
                        ...
                        During the holidays like Chinese New Year, or the mid autumn festival, my family would gather together and cook. Each dish was unique significant, and often time symbolic. 
                        ...
                        explore and share their favorite recipes. Please check out recipes or share you own.
                    </p>
                </div>
